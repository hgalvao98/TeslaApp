        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                <View style={{ padding: 20 }}>
                    <Text style={styles.title}>About Tesla</Text>
                    <Text style={styles.subtitle}>Tesla’s mission is to accelerate the world’s transition to sustainable energy.</Text>
